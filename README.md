...
Foundation in progress. Core architecture exists; product features are not yet complete.

Disabled future systems must not be faked:
...
- [Production deployment on Debian 12](docs/DEPLOYMENT_DEBIAN_12.md)
- [API](docs/API.md)
