...
const baseMessages = {
  ...
  "section.experts.intro":
    "Choose a verified reviewer, select a photo from your profile and order a professional assessment.",
...
const ruMessages: Partial<MessageMap> = {
  ...
  "section.experts.intro":
    "Выберите подтверждённого рецензента, фотографию из профиля и закажите профессиональную оценку.",
