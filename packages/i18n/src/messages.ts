...
const baseMessages = {
  ...
  "photo.chooseAnother": "Choose another file",
  ...
  "location.searchPlaceholder": "Start typing a city",
  "location.photoPlaceholder": "Optional city override",
  "location.profileHint": "Choose a real populated place from the list.",
  "location.photoHint":
...
const ruMessages: Partial<MessageMap> = {
  ...
  "photo.chooseAnother": "Выбрать другой файл",
  ...
  "location.searchPlaceholder": "Начните вводить город",
  "location.photoPlaceholder": "Можно указать город вручную",
  "location.profileHint":
    "Выберите реально существующий населённый пункт из списка.",
  "location.photoHint":
